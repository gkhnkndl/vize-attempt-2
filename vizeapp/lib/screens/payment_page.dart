...
class _ShopPageState extends State<PaymentPage> {
  ...
  MaterialStateProperty<Color?> overlayColor = MaterialStateColor.resolveWith((states) => Colors.transparent);
          ...
          children: [
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(borderSide: BorderSide(color: Colors.cyan.shade300))),
              controller: titleCnt,
            ),
            const Gap(10),
            TextFormField(
            ...
            SwitchListTile(
              activeTrackColor: const Color.fromARGB(255, 32, 229, 255) ,
              activeColor: Theme.of(context).colorScheme.secondary,
              trackColor: overlayColor,
              value: remember,
              title:const Text("Keep Card"),
